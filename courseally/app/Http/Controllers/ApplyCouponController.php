            ...
            if ($cart->course_id == $coupon->course_id) {
              ...
              Cart::where('course_id', '=', $coupon['course_id'])->where('user_id', '=', Auth::user()
                ...
                Cart::where('course_id', '!=', $coupon['course_id'])->where('user_id', '=', Auth::user()
                    ...
                    $carts=  Cart::where('course_id', '=', $coupon['course_id'])->where('user_id', '=', Auth::user()
                    ->id)->first();
                ...
                $carts= DB::table('carts')->where('course_id', '=', $coupon['course_id'])->where('user_id', '=', Auth::user()->id)->first();
                ...
                $course = Course::where('id',$carts->course_id)->first();
              // 
